...
% Outputs --
% xdot [4x1] - [Vidot , gammadot, phidot , phidotdot, xdot, zdot]
...
phidot = x(4);
phidotdot = ((1/2)*rho*chord*span*Va^2*Cm*chord + l*(u(2)-u(1)))/Iyy;
xdot = x(1)*cos(x(2));
zdot = x(1)*sin(x(2));
...
xdot = [Vidot gammadot phidot phidotdot, xdot, zdot]';
end